      ...
      {variant !== 'mark-only' && (
        <div className="flex flex-col text-left min-w-0 flex-1 overflow-hidden">
          <div className="flex items-baseline gap-1.5 sm:gap-2">
            ...
            <span className={`font-cormorant brand-logo-text font-bold italic ${currentSize.text} bg-gradient-to-r from-[#FFFFFF] via-[#FAF5EF] to-[#E8A53E] bg-clip-text text-transparent leading-none drop-shadow-[0_2px_10px_rgba(255,255,255,0.15)] shrink-0`}>
              Aastitva
            </span>
