...
export const ConclaveKernelHUD: React.FC = () => {
  ...
  return (
    <div className="w-full rounded-3xl bg-gradient-to-b from-[#0B1224]/95 via-[#070A14]/95 to-[#050811]/95 border-2 border-[#D4AF37]/50 shadow-[0_25px_80px_rgba(0,0,0,0.9)] overflow-hidden font-mono text-left relative group">
      ...
      <div className="bg-gradient-to-r from-[#16203B] via-[#0D1427] to-[#16203B] px-4 py-2.5 border-b border-[#D4AF37]/35 flex items-center justify-between select-none">
        <div className="flex items-center gap-2.5">
          ...
          <span className="text-xs font-bold text-[#FAF5EF] tracking-wider truncate">
            Aastitva_Quantum_Kernel.exe [Planetary Core Matrix]
          </span>
        </div>

        {/* Windows XP Futuristic Jewel Window Controls */}
        <div className="flex items-center gap-1.5 shrink-0">
          <span className="w-3 h-3 rounded-full bg-amber-500/80 border border-amber-300/40 shadow-sm cursor-pointer" />
          <span className="w-3 h-3 rounded-full bg-emerald-500/80 border border-emerald-300/40 shadow-sm cursor-pointer" />
          <span className="w-3 h-3 rounded-full bg-rose-500/80 border border-rose-300/40 shadow-sm cursor-pointer" />
        </div>
      </div>

      {/* Main HUD Body with Fused 3D Holographic Orbiting Core */}
      <div className="p-5 sm:p-7 space-y-6 font-jakarta">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-4 items-center p-5 rounded-2xl bg-[#070A14]/90 border border-[#D4AF37]/35 shadow-inner">
          ...
          <div className="md:col-span-4 h-48 sm:h-56 relative rounded-2xl overflow-hidden bg-black/50 border border-[#D4AF37]/30 flex items-center justify-center p-1">
