          ...
          return (
            <ScrollReveal key={offering.id} direction="up" delay={idx * 0.08}>
              <div className="glass-card rounded-3xl overflow-hidden shadow-2xl transition-all duration-300 hover:border-[#D4AF37]/50">
                ...
                <div className="relative min-h-[220px] sm:min-h-[260px] flex items-end p-6 sm:p-8 dark-photo-overlay">
                  ...
                  <div className="relative z-10 w-full flex flex-col sm:flex-row sm:items-end justify-between gap-4 text-left">
                    <div className="space-y-2 max-w-2xl">
                      <span className="px-3 py-1 rounded-md bg-[#D4AF37] text-[#171026] text-xs font-bold uppercase tracking-wider font-jakarta">
                        {offering.category}
                      </span>
                      <h2 className="text-2xl sm:text-3xl font-cormorant font-bold text-[#FAF5EF]">
                        {offering.title}
                      </h2>
                    ...
                    <button
                      ...
                      className="px-4 py-2.5 rounded-xl bg-[#171026]/90 border border-[#D4AF37]/40 text-[#D4AF37] text-xs font-bold hover:bg-[#372C68] transition-all flex items-center gap-2 shrink-0 self-start sm:self-auto backdrop-blur-md min-touch font-jakarta"
                    >
                ...
                {/* Highlights Ribbon */}
                <div className="bg-[#120D1F]/90 px-6 sm:px-8 py-3 border-y border-[#52459E]/30 flex flex-wrap items-center gap-4 text-xs font-jakarta">
                ...
                {isExpanded && (
                  <div className="p-6 sm:p-8 bg-[#171026]/95 space-y-6 animate-page-enter font-jakarta text-left">
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                        {offering.details.map((detail, dIdx) => (
                          <div key={dIdx} className="p-3.5 rounded-xl bg-[#231B42]/80 border border-[#52459E]/30 text-xs text-[#FAF5EF] flex items-start gap-2.5">
                    ...
                    <div className="pt-4 border-t border-[#52459E]/30 flex justify-end">
                      <button
                        ...
                        className="px-6 py-3 rounded-xl shimmer-btn text-[#171026] text-xs font-bold shadow-lg hover:brightness-110 flex items-center gap-2 min-touch"
                      >
