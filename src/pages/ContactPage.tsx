  ...
  return (
    <div className="relative font-sans text-[#FAF5EF] py-12 px-4 sm:px-6 max-w-7xl mx-auto space-y-12">
      ...
      <div id="partner-form" className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
        {/* Inquiry Form */}
        <div className="lg:col-span-7 font-jakarta">
          <ScrollReveal direction="up" delay={0.15}>
            <div className="glass-card rounded-3xl p-6 sm:p-8 space-y-6 text-left">
              <div className="flex items-center justify-between pb-4 border-b border-[#52459E]/40">
                ...
                <span className="text-xs text-[#D4AF37] font-semibold flex items-center gap-1 font-jakarta">
              ...
              {submitted ? (
                <div className="p-8 rounded-2xl bg-emerald-500/15 border border-emerald-400/40 text-center space-y-4">
                  ...
                  <button
                    ...
                    className="px-6 py-2.5 rounded-xl bg-[#231B42] text-xs font-bold text-[#D4AF37] border border-[#D4AF37]/40 hover:bg-[#372C68] min-touch"
                  >
        ...
        <div className="lg:col-span-5 space-y-6 font-jakarta text-left">
